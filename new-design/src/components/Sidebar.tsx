...
const menuItems = [
  { id: 'dashboard' as Page, label: 'Gösterge Paneli', icon: LayoutDashboard },
  { id: 'new-broadcast' as Page, label: 'Yeni Yayın', icon: Send },
  { id: 'groups' as Page, label: 'Gruplar', icon: Users },
  { id: 'active' as Page, label: 'Aktif Yayınlar', icon: Radio },
    ...
    >
      ...
      <div className="p-6 border-b border-indigo-500/10">
        ...
        >
          ...
          <div>
            <h1 className="text-xl font-bold gradient-text">TeleBot</h1>
